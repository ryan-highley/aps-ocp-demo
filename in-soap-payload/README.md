...
You can then execute your native executable with: `./target/in-soap-payload-1.0.0-SNAPSHOT-runner`
...
- Camel CXF ([guide](https://access.redhat.com/documentation/en-us/red_hat_integration/2.latest/html/camel_extensions_for_quarkus_reference/extensions-cxf-soap)): Expose SOAP WebServices using Apache CXF or connect to external WebServices using CXF WS client
- Camel Quartz ([guide](https://access.redhat.com/documentation/en-us/red_hat_integration/2.latest/html/camel_extensions_for_quarkus_reference/extensions-quartz)): Schedule sending of messages using the Quartz 2.x scheduler
- Camel JAXB ([guide](https://access.redhat.com/documentation/en-us/red_hat_integration/2.latest/html/camel_extensions_for_quarkus_reference/extensions-jaxb)): Unmarshal XML payloads to POJOs and back using JAXB2 XML marshalling standard
